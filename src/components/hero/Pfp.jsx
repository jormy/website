  ...
  return (
    <div className="[perspective:1000px]">
      <img
        ...
        className="hidden h-72 w-72 rounded-2xl transition-transform ease-out hover:[transform:rotateX(var(--xRotation))_rotateY(var(--yRotation))_scale(1.05)] md:block"
      />
    </div>
  );
};
